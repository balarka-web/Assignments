...
function palindrome() {
    ...
    document.getElementById('palindrome').innerHTML = res + " for mom"
}
...
function nearestLarger() {
    ...
    document.getElementById('large').innerHTML = "Nearest Larger for 4 in [1,2,3,4,5,6] is = " + res
}